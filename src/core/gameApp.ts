    ...
    this.rooms = new RoomController(
      {
        ...
        generator: {
          ...
          placementAttemptsPerObstacle: config.generation.placementAttemptsPerObstacle,
          gridCellSize: config.generation.gridCellSize,
          minimumCombatAreaCells: config.generation.minimumCombatAreaCells,
          playerRadius: config.player.colliderRadius,
          triggerInset: config.room.triggerInset,
          minimumObstacleHeight: config.player.stepHeight,
        },
        triggerInset: config.room.triggerInset,
